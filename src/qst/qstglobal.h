...
MatchPolicy;
	...
	typedef enum {
					...
					ClauseValued_Mask		= ClauseWhere  | ClauseInsert | ClauseUpdate | ClauseParameters,
					ClauseModifying_Mask	= ClauseInsert | ClauseUpdate,
					ClauseHasFieldName_Mask = ClauseSelect | ClauseWhere  | ClauseInsert | ClauseUpdate | ClauseOrderBy | ClauseGroupBy,
					ClauseAllButSelect_Mask = ClauseAll_Mask ^ ClauseSelect
				}
			QueryClause;
...
typedef enum	{
					NoPlaceholders    = 0, /*!< No percent sign.*/
