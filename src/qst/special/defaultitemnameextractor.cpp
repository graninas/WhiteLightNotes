...
\endlang
*/
QString DefaultItemNameExtractor::extractItemName() const
{
...
\endlang
*/
QString DefaultItemNameExtractor::extractItemName(const QString &str) const
{
	if (str.isEmpty())
		return QString();
	...
	if (pos != -1)
	{
		return _getFromBrackets(resString.mid(4 + pos));
	}
	else
	{
