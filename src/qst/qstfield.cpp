...
/*!
\lang_Russian
	Устанавливает данное поле для отображения в QComboBox.
\endlang

\lang_English
	Sets field to display in QComboBox.
\endlang */
void QstField::setModelColumn(const bool &modelColumn)
{
	_modelColumn = modelColumn;
}
...
bool QstField::isModelColumn() const
{
	return _modelColumn;
}
