...
void createTables()
{
	...
	Qst::QstAbstractModelHandler::evalQuery("CREATE TABLE IF NOT EXISTS note (id INTEGER PRIMARY KEY AUTOINCREMENT, html_text TEXT, simple_text TEXT, date TEXT, complex_data TEXT)");
